...
<% await tp.file.move("/DM Board/The World/Locations/Points of Interest/" + tp.file.title) %>

<%*
const hasTitle = !tp.file.title.startsWith("NewPOI");
let title;
if (!hasTitle) {
    title = await tp.system.prompt("Enter Point of Interest Name");
