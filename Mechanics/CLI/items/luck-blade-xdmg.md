...
If the weapon is on your person, you can call on its luck (no action required) to reroll one failed [D20 Test](/Mechanics/CLI/variant-rules/d20-test-xphb.md) if you don't have the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated) condition. You must use the second roll. Once used, this property can't be used again until the next dawn.
