...
You can take the [Dash](/Mechanics/CLI/actions.md#Dash) action as a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md). When you do so, you gain a number of [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md) equal to your [Proficiency Bonus](/Mechanics/CLI/variant-rules/proficiency-xphb.md).

You can use this trait a number of times equal to your [Proficiency Bonus](/Mechanics/CLI/variant-rules/proficiency-xphb.md), and you regain all expended uses when you finish a [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md) or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md).
...
When you are reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) but not killed outright, you can drop to 1 [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md) instead. Once you use this trait, you can't do so again until you finish a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md).
