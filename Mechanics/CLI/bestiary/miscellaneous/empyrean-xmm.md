...
"saves":
  ...
  - "wisdom": !!int "13"
"skillsaves":
  - "name": "[Insight](/Mechanics/CLI/skills.md#Insight)"
    "desc": "+13"
...
"traits":
  ...
  - "desc": "The empyrean has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +17, reach 10 ft. *Hit:* 31 (6d6 + 10) Force damage,\
      \ and the target has the [Stunned](/Mechanics/CLI/conditions.md#Stunned) condition\
      \ until the start of the empyrean's next turn. The target can choose not to\
      \ be [Stunned](/Mechanics/CLI/conditions.md#Stunned), in which case it takes\
      \ an extra 21 Force damage that bypasses [Resistance](/Mechanics/CLI/variant-rules/resistance-xphb.md)\
      \ or [Immunity](/Mechanics/CLI/variant-rules/immunity-xphb.md)."
    "name": "Sacred Weapon"
  ...
  - "desc": "The empyrean casts one of the following spells, requiring no Material\
      ...
      \ [Pass without Trace](/Mechanics/CLI/spells/pass-without-trace-xphb.md), [Water\
      \ Breathing](/Mechanics/CLI/spells/water-breathing-xphb.md)\n\n**1/day each:**\
      \ [Commune](/Mechanics/CLI/spells/commune-xphb.md), [Dispel Evil and Good](/Mechanics/CLI/spells/dispel-evil-and-good-xphb.md),\
...
"legendary_actions":
  - "desc": "The empyrean gains 10 [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md),\
      \ and the empyrean and each ally within 30 feet of it gain [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ on [D20 Tests](/Mechanics/CLI/variant-rules/d20-test-xphb.md) until the end\
      \ of the empyrean's next turn. The empyrean can't take this action again until\
      \ the start of its next turn."
    "name": "Bolster"
  - "desc": "*Constitution Saving Throw:* DC 23, each creature in a 30-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
