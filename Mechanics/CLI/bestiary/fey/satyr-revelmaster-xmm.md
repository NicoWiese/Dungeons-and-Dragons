...
"cr": "6"
"traits":
  - "desc": "The satyr has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Bludgeoning\
      \ damage, and the target has the [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
  ...
  - "desc": "The satyr conjures a charming or frightening song. *Wisdom Saving Throw:*\
      \ DC 14, each enemy in a 60-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the satyr. *Failure:* The target is subjected to the song's\
      \ effect:\n\n- **Charming.** The target has the [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
      \ condition for 1 minute. While [Charmed](/Mechanics/CLI/conditions.md#Charmed),\
