...
"skillsaves":
  - "name": "[Athletics](/Mechanics/CLI/skills.md#Athletics)"
    "desc": "+7"
  - "name": "[Nature](/Mechanics/CLI/skills.md#Nature)"
    "desc": "+5"
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +7, range 90 ft. *Hit:* 14 (3d6 + 4) Radiant damage,\
      \ and the target has the [Blinded](/Mechanics/CLI/conditions.md#Blinded) condition\
  ...
  - "desc": "The centaur casts one of the following spells, using Wisdom as the spellcasting\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The centaur moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      ...
      \ 4) Bludgeoning damage, and the target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
