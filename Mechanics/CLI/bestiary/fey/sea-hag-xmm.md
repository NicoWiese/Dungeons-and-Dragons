...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Slashing damage."
    "name": "Claw"
  - "desc": "*Wisdom Saving Throw:* DC 11, one [Frightened](/Mechanics/CLI/conditions.md#Frightened)\
      \ creature the hag can see within 30 feet. *Failure:* If the target has 20 [Hit\
      \ Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) or fewer, it drops\
      \ to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md). Otherwise,\
