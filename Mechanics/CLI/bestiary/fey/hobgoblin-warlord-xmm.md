...
"saves":
  ...
  - "charisma": !!int "5"
"gear":
  - "nine [javelins](/Mechanics/CLI/items/javelin-xphb.md)"
  - "[longsword](/Mechanics/CLI/items/longsword-xphb.md)"
...
"cr": "6"
"traits":
  - "desc": "While in a 30-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the hobgoblin, the hobgoblin and its allies have [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ on attack rolls and saving throws, provided the hobgoblin doesn't have the\
      \ [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated) condition."
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +6, reach 5 ft. or range 30/120 ft. *Hit:*\
      \ 11 (2d6 + 4) Piercing damage, and the target's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
