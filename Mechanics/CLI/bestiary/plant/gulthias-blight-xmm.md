...
"condition_immunities": "[deafened](/Mechanics/CLI/conditions.md#Deafened)"
"senses": "[Blindsight](/Mechanics/CLI/senses.md#Blindsight) 120 ft., passive Perception\
  \ 19"
"languages": "Common, Druidic"
"cr": "16"
"traits":
  - "desc": "When it finishes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md),\
      ...
      \ [Twig Blight](/Mechanics/CLI/bestiary/plant/twig-blight-xmm.md); on 5-6, [Needle\
      \ Blight](/Mechanics/CLI/bestiary/plant/needle-blight-xmm.md); on 7-8, [Vine\
      \ Blight](/Mechanics/CLI/bestiary/plant/vine-blight-xmm.md)."
    "name": "Blight Seeds"
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 20, one Huge or smaller creature the\
      ...
      \ the target has the [Grappled](/Mechanics/CLI/conditions.md#Grappled) condition\
      \ (escape DC 17) from one of six roots. Until the grapple ends, the target has\
      \ the [Restrained](/Mechanics/CLI/conditions.md#Restrained) condition and takes\
      \ 14 (4d6) Necrotic damage at the start of each of its turns. The target's [Hit\
      \ Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md) maximum decreases\
      \ by an amount equal to the Necrotic damage taken, and the blight regains [Hit\
      \ Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) equal to that amount."
