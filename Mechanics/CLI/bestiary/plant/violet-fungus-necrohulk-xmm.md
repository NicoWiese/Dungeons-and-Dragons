...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 15, each creature in a 20-foot-radius\
      ...
      \ condition until the start of the necrohulk's next turn. While [Poisoned](/Mechanics/CLI/conditions.md#Poisoned),\
...
"bonus_actions":
  - "desc": "*Strength Saving Throw:* DC 15, one Medium or Small creature the necrohulk\
      ...
      \ grafted at a time.\n\nWhile grafted, the target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition and [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      ...
      \ the necrohulk regains 10 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md).\n\
      \nThe grafted target or a creature within 5 feet of the necrohulk can take an\
      \ action to make a DC 15 Strength ([Athletics](/Mechanics/CLI/skills.md#Athletics))\
