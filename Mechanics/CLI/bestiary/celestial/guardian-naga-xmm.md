...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed), [paralyzed](/Mechanics/CLI/conditions.md#Paralyzed),\
  \ [poisoned](/Mechanics/CLI/conditions.md#Poisoned), [restrained](/Mechanics/CLI/conditions.md#Restrained)"
...
"traits":
  - "desc": "If the naga dies, it returns to life in 1d6 days and regains all its\
      \ [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) unless [Dispel\
      \ Evil and Good](/Mechanics/CLI/spells/dispel-evil-and-good-xphb.md) is cast\
      \ on its remains."
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 16, one creature the naga can see within\
      \ 60 feet. *Failure:* 31 (7d8) Poison damage, and the target has the [Blinded](/Mechanics/CLI/conditions.md#Blinded)\
  ...
  - "desc": "The naga casts one of the following spells, requiring no Somatic or Material\
      ...
      **1/day each:** [Clairvoyance](/Mechanics/CLI/spells/clairvoyance-xphb.md),\
      \ [Cure Wounds](/Mechanics/CLI/spells/cure-wounds-xphb.md) (level 6 version),\
      \ [Flame Strike](/Mechanics/CLI/spells/flame-strike-xphb.md) (level 6 version),\
      \ [Geas](/Mechanics/CLI/spells/geas-xphb.md), [True Seeing](/Mechanics/CLI/spells/true-seeing-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
