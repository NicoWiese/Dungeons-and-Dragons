...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
      \ its permission. Wisdom ([Insight](/Mechanics/CLI/skills.md#Insight)) checks\
      \ made to ascertain its intentions or sincerity are made with [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)."
    "name": "Inscrutable"
...
"actions":
  ...
  - "desc": "The sphinx emits a magical roar. Whenever it roars, the roar has a different\
      \ effect, as detailed below (the sequence resets when it takes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md)):\n\
      \n- **First Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened)\
      \ condition for 1 minute.  \n- **Second Roar.** *Wisdom Saving Throw:* DC 20,\
      \ each enemy in a 500-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      \ [Heroes' Feast](/Mechanics/CLI/spells/heroes-feast-xphb.md), [Zone of Truth](/Mechanics/CLI/spells/zone-of-truth-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is\
      ...
      \ a [Study](/Mechanics/CLI/actions.md#Study) action while within 1 mile of the\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 16, one creature the sphinx can see within\
      \ 120 feet. *Failure:* The target gains 1 [Exhaustion](/Mechanics/CLI/conditions.md#Exhaustion)\
      \ level. While the target has any [Exhaustion](/Mechanics/CLI/conditions.md#Exhaustion)\
