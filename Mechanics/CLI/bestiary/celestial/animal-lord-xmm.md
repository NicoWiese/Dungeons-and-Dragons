...
"saves":
  ...
  - "wisdom": !!int "12"
"skillsaves":
  - "name": "[Acrobatics](/Mechanics/CLI/skills.md#Acrobatics)"
    "desc": "+13"
...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ [Charmed](/Mechanics/CLI/conditions.md#Charmed) condition until the end of\
      \ its next turn. While [Charmed](/Mechanics/CLI/conditions.md#Charmed), the\
      \ target has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
      \ condition.  \n- **Fearful (Hunter Only).** The target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened)\
  ...
  - "desc": "The animal lord has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      - **Fortify (Forager Only).** The animal lord gains 20 [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md).\
      \  \n- **Marked as Prey (Hunter Only).** The animal lord has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ on attack rolls against the target until the start of the animal lord's next\
      \ turn.  \n- **Pesky Swarm (Sage Only).** The target has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
...
"legendary_actions":
  - "desc": "The animal lord moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
