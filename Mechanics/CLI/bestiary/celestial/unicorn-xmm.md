...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed), [paralyzed](/Mechanics/CLI/conditions.md#Paralyzed),\
...
"traits":
  ...
  - "desc": "The unicorn has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The unicorn casts one of the following spells, requiring no spell components\
      ...
      \ [Calm Emotions](/Mechanics/CLI/spells/calm-emotions-xphb.md), [Dispel Evil\
      \ and Good](/Mechanics/CLI/spells/dispel-evil-and-good-xphb.md), [Entangle](/Mechanics/CLI/spells/entangle-xphb.md),\
      \ [Pass without Trace](/Mechanics/CLI/spells/pass-without-trace-xphb.md), [Word\
      \ of Recall](/Mechanics/CLI/spells/word-of-recall-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"regional_effects":
  - "desc": "The region containing a unicorn's lair is changed by its presence, creating\
      ...
      \ have [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md) on Dexterity\
      \ ([Stealth](/Mechanics/CLI/skills.md#Stealth)) checks while within 1 mile of\
      \ the lair.  \n- **Positive Energy.** Whenever a creature within 1 mile of the\
      \ lair regains [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ from a spell, it regains the maximum number of [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"legendary_actions":
  - "desc": "The unicorn moves up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
  ...
  - "desc": "The unicorn targets itself or one creature it can see within 60 feet\
      \ of itself. The target gains 10 (3d6) [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md),\
