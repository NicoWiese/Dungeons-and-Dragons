...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
    ...
    "name": "Inscrutable"
  - "desc": "The sphinx has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
"actions":
  - "desc": "The sphinx makes three Claw attacks. It can replace one attack with a\
      \ use of [Curse](/Mechanics/CLI/variant-rules/curses-xphb.md) of the Riddle."
    "name": "Multiattack"
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ a riddle. The cursed target has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
