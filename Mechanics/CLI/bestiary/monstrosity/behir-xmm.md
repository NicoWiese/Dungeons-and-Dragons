...
"senses": "[Darkvision](/Mechanics/CLI/senses.md#Darkvision) 90 ft., passive Perception\
  \ 16"
"languages": "Draconic"
"cr": "11"
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 18, one Large or smaller creature the behir\
      ...
      \ has the [Grappled](/Mechanics/CLI/conditions.md#Grappled) condition (escape\
      \ DC 16), and it has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
...
"bonus_actions":
  - "desc": "*Dexterity Saving Throw:* DC 18, one Large or smaller creature [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ by the behir (the behir can have only one creature swallowed at a time). *Failure:*\
      \ The behir swallows the target, which is no longer [Grappled](/Mechanics/CLI/conditions.md#Grappled).\
      \ While swallowed, a creature has the [Blinded](/Mechanics/CLI/conditions.md#Blinded)\
      \ and [Restrained](/Mechanics/CLI/conditions.md#Restrained) conditions, has\
      \ [Total Cover](/Mechanics/CLI/variant-rules/cover-xphb.md) against attacks\
      ...
      \ creature, which falls in a space within 10 feet of the behir and has the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      \ condition. If the behir dies, a swallowed creature is no longer [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ and can escape from the corpse by using 15 feet of movement, exiting [Prone](/Mechanics/CLI/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "XMM"
