...
"skillsaves":
  ...
  - "name": "[Stealth](/Mechanics/CLI/skills.md#Stealth)"
    "desc": "+6"
"senses": "[Darkvision](/Mechanics/CLI/senses.md#Darkvision) 150 ft., passive Perception\
  \ 14"
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +5, range 150 ft. *Hit:* 11 (2d8 + 2) Poison damage."
    "name": "Poison Ray"
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 13, each creature in a 30-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ If the medusa sees its reflection in the [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md),\
      \ the medusa must make this save. *1St Failure:* The target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
