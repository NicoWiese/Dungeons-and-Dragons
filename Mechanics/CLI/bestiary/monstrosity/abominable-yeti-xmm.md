...
"cr": "9"
"traits":
  - "desc": "If the yeti takes Fire damage, it has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the yeti can see within\
      \ 30 feet. *Failure:* 21 (6d6) Cold damage, and the target has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
      \ condition until the start of the yeti's next turn unless the target has [Immunity](/Mechanics/CLI/variant-rules/immunity-xphb.md)\
      \ to Cold damage. *Success:* The target is immune to this yeti's Chilling Gaze\
      \ for 1 hour."
    "name": "Chilling Gaze"
  - "desc": "*Constitution Saving Throw:* DC 18, each creature in a 30-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
