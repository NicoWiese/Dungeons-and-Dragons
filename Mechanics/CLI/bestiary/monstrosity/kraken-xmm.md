...
"saves":
  ...
  - "wisdom": !!int "11"
"skillsaves":
  - "name": "[History](/Mechanics/CLI/skills.md#History)"
    "desc": "+13"
  - "name": "[Perception](/Mechanics/CLI/skills.md#Perception)"
    "desc": "+11"
"damage_immunities": "cold, lightning"
"condition_immunities": "[frightened](/Mechanics/CLI/conditions.md#Frightened), [grappled](/Mechanics/CLI/conditions.md#Grappled),\
  \ [paralyzed](/Mechanics/CLI/conditions.md#Paralyzed), [restrained](/Mechanics/CLI/conditions.md#Restrained)"
"senses": "[Truesight](/Mechanics/CLI/senses.md#Truesight) 120 ft., passive Perception\
  \ 21"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +17, reach 30 ft. *Hit:* 24 (4d6 + 10) Bludgeoning\
      \ damage. The target has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ condition (escape DC 20) from one of ten tentacles, and it has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition until the grapple ends."
    "name": "Tentacle"
  - "desc": "The kraken throws a Large or smaller creature [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      ...
      \ has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition. *Success:*\
      \ Half damage only."
    "name": "Fling"
  ...
  - "desc": "*Dexterity Saving Throw:* DC 25, one creature [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      ...
      \ and no longer [Grappled](/Mechanics/CLI/conditions.md#Grappled). A swallowed\
      \ creature has the [Restrained](/Mechanics/CLI/conditions.md#Restrained) condition,\
      \ has [Total Cover](/Mechanics/CLI/variant-rules/cover-xphb.md) against attacks\
      ...
      \ the [Prone](/Mechanics/CLI/conditions.md#Prone) condition. If the kraken dies,\
      \ any swallowed creature no longer has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
...
"regional_effects":
  - "desc": "The region containing a kraken's lair is twisted by its presence, creating\
      ...
      \ [Charmed](/Mechanics/CLI/conditions.md#Charmed) condition while in that area.\
      \  \n- **Sea and Storms.** While in its lair, the kraken can cast [Control Weather](/Mechanics/CLI/spells/control-weather-xphb.md),\
...
"legendary_actions":
  - "desc": "The kraken uses Lightning Strike."
    "name": "Storm Bolt"
  - "desc": "*Constitution Saving Throw:* DC 23, each creature in a 15-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the kraken while it is underwater. *Failure:* The target\
      \ has the [Blinded](/Mechanics/CLI/conditions.md#Blinded) and [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
      \ conditions until the end of the kraken's next turn. The kraken then moves\
      \ up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md). *Failure or\
