...
"traits":
  - "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
      \ adhered to the mimic has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      ...
      \ damage if the target is [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 7 (1d8 + 3) Bludgeoning damage\
      ...
      \ DC 13). Ability checks made to escape this grapple have [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)."
    "name": "Pseudopod"
"bonus_actions":
