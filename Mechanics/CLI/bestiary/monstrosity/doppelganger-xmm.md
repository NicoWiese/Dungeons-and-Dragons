...
"actions":
  - "desc": "The doppelganger makes two Slam attacks and uses Unsettling Visage if\
      \ available."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +6 (with [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ during the first round of each combat), reach 5 ft. *Hit:* 11 (2d6 + 4) Bludgeoning\
      \ damage."
    "name": "Slam"
  - "desc": "*Wisdom Saving Throw:* DC 12, each creature in a 15-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
