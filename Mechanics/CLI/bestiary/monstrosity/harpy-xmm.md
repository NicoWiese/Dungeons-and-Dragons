...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 6 (2d4 + 1) Slashing damage."
    "name": "Claw"
  - "desc": "The harpy sings a magical melody, which lasts until the harpy's [Concentration](/Mechanics/CLI/conditions.md#Concentration)\
      ...
      \ the [Charmed](/Mechanics/CLI/conditions.md#Charmed) condition until the song\
      \ ends and repeats the save at the end of each of its turns. While [Charmed](/Mechanics/CLI/conditions.md#Charmed),\
      ...
      \ avoid [Opportunity Attacks](/Mechanics/CLI/actions.md#Opportunity%20Attack);\
