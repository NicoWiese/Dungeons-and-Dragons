...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 5 (1d6 + 2) Piercing damage\
      \ plus 2 (1d4) Poison damage, and the target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
  ...
  - "desc": "*Dexterity Saving Throw:* DC 12, one Large or smaller creature the ettercap\
      \ can see within 30 feet. *Failure:* The target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition until the web is destroyed (AC 10; HP 5; [Vulnerability](/Mechanics/CLI/variant-rules/vulnerability-xphb.md)\
      \ to Fire damage; [Immunity](/Mechanics/CLI/variant-rules/immunity-xphb.md)\
      \ to Bludgeoning, Poison, and Psychic damage)."
    "name": "Web Strand (Recharge 5-6)"
"bonus_actions":
  - "desc": "The ettercap pulls one creature within 30 feet of itself that is [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
