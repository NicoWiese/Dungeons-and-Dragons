...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (1d10 + 3) Piercing damage\
      \ plus 9 (2d8) Poison damage. If this damage reduces the target to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md),\
      \ the target becomes [Stable](/Mechanics/CLI/variant-rules/stable-xphb.md),\
      \ and it has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned) condition\
      \ for 1 hour. While [Poisoned](/Mechanics/CLI/conditions.md#Poisoned), the target\
      \ also has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed) condition."
    "name": "Bite"
"bonus_actions":
