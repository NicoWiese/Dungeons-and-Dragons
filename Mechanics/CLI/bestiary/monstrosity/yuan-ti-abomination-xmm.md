...
"cr": "7"
"traits":
  - "desc": "The yuan-ti has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Large or smaller creature within\
      \ 5 feet. *Failure:* 28 (7d6 + 4) Bludgeoning damage. The target has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ condition (escape DC 14), and it has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition until the grapple ends. *Success:* Half damage only."
    "name": "Constrict"
  - "desc": "*Constitution Saving Throw:* DC 14, each creature in a 30-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 21 (6d6) Poison damage, and the target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
      \ condition until the end of the yuan-ti's next turn. While [Poisoned](/Mechanics/CLI/conditions.md#Poisoned),\
