...
"traits":
  ...
  - "desc": "The hydra has five heads. Whenever the hydra takes 25 damage or more\
      ...
      \ [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) when it grows\
      \ new heads."
    "name": "Multiple Heads"
  - "desc": "For each head the hydra has beyond one, it gets an extra [Reaction](/Mechanics/CLI/variant-rules/reaction-xphb.md)\
      \ that can be used only for [Opportunity Attacks](/Mechanics/CLI/actions.md#Opportunity%20Attack)."
    "name": "Reactive Heads"
"actions":
