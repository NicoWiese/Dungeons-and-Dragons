...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Piercing damage\
    ...
    "name": "Bite"
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 30-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ If the basilisk sees its reflection within the [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md),\
      \ the basilisk must make this save. *1St Failure:* The target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
