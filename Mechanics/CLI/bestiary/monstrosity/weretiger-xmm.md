...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 12 (2d8 + 3) Piercing damage.\
      ...
      \ it instead becomes a Weretiger under the DM's control and has 10 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md).\
...
"bonus_actions":
  - "desc": "The weretiger moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      \ without provoking [Opportunity Attacks](/Mechanics/CLI/actions.md#Opportunity%20Attack).\
      \ At the end of this movement, the weretiger can take the [Hide](/Mechanics/CLI/actions.md#Hide)\
      \ action."
