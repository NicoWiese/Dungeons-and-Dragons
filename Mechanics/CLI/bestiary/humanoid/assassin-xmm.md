...
"gear":
  - "[light crossbow](/Mechanics/CLI/items/light-crossbow-xphb.md)"
  - "[shortsword](/Mechanics/CLI/items/shortsword-xphb.md)"
  - "[studded leather armor](/Mechanics/CLI/items/studded-leather-armor-xphb.md)"
...
"traits":
  - "desc": "If the assassin is subjected to an effect that allows it to make a Dexterity\
      ...
      \ this trait if it has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
      \ condition."
    "name": "Evasion"
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 7 (1d6 + 4) Piercing damage\
      \ plus 17 (5d6) Poison damage, and the target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
  ...
  - "desc": "*Ranged Attack Roll:* +7, range 80/320 ft. *Hit:* 8 (1d8 + 4) Piercing\
    ...
    "name": "Light Crossbow"
"bonus_actions":
  - "desc": "The assassin takes the [Dash](/Mechanics/CLI/actions.md#Dash), [Disengage](/Mechanics/CLI/actions.md#Disengage),\
