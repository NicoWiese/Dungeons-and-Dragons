...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed) (except from\
  \ its vampire master)"
"gear":
  - "ten [daggers](/Mechanics/CLI/items/dagger-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +5, reach 5 ft. or range 20/60 ft. *Hit:*\
      ...
      \ reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ by this attack, the target becomes [Stable](/Mechanics/CLI/variant-rules/stable-xphb.md)\
      \ but has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned) condition for\
      \ 1 hour. While it has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
      \ condition, the target has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
      \ condition."
    "name": "Umbral Dagger"
"bonus_actions":
  - "desc": "The familiar takes the [Dash](/Mechanics/CLI/actions.md#Dash) or [Disengage](/Mechanics/CLI/actions.md#Disengage)\
      \ action."
