...
"skillsaves":
  ...
  - "name": "[Perception](/Mechanics/CLI/skills.md#Perception)"
    "desc": "+6"
"gear":
  - "[pistol](/Mechanics/CLI/items/pistol-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 16 (3d6 + 6) Slashing damage\
      ...
      \ of the pirate's choice:\n\n- **Awestruck.** The target has the [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
...
"bonus_actions":
  - "desc": "The pirate chooses up to three other creatures it can see within 30 feet.\
      \ Until the start of the pirate's next turn, the targets have [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
