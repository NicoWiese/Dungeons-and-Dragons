...
"regional_effects":
  - "desc": "The region containing an adult or ancient blue dragon's lair is changed\
      ...
      \ in that area other than the dragon and its allies finishes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md),\
      ...
      \ within 1 mile of the lair. The area is [Lightly Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md).\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Invisibility](/Mechanics/CLI/spells/invisibility-xphb.md)\
      \ on itself, and it can fly up to half its [Fly Speed](/Mechanics/CLI/variant-rules/fly-speed-xphb.md).\
