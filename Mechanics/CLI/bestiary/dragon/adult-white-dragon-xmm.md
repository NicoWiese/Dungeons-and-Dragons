...
"traits":
  - "desc": "The dragon can move across and climb icy surfaces without needing to\
      \ make an ability check. Additionally, [Difficult Terrain](/Mechanics/CLI/variant-rules/difficult-terrain-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +11, reach 10 ft. *Hit:* 13 (2d6 + 6) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 19, each creature in a 60-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient white dragon's lair is affected\
      ...
      \  \n- **Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md)\
      ...
      \ or have its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) reduced by\
      \ 10 feet for 1 hour.  \n\nIf the dragon dies or moves its lair elsewhere, these\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 14, each creature in a 30-foot-radius\
      ...
      \ and the target's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) is 0\
