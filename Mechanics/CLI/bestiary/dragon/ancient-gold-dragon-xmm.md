...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +17 to hit, reach 15 ft. *Hit:* 19 (2d8 + 10) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 24, each creature in a 90-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "*Strength Saving Throw:* DC 24, each creature that isn't currently affected\
      \ by this breath in a 90-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      \ on Strength-based [D20 Tests](/Mechanics/CLI/variant-rules/d20-test-xphb.md)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ form only, no [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient gold dragon's lair is altered\
      ...
      \ Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md) by opalescent\
      \ fog. While in that area, creatures can't be [surprised](/Mechanics/CLI/conditions.md#Surprised),\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 24, one creature the dragon can see within\
      \ 120 feet. *Failure:* 24 (7d6) Force damage, and the target has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
