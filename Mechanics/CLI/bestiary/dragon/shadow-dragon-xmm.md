...
"traits":
  ...
  - "desc": "While in [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md), the dragon has\
      \ [Resistance](/Mechanics/CLI/variant-rules/resistance-xphb.md) to damage that\
      \ isn't Force, Psychic, or Radiant."
    "name": "Living Shadow"
  - "desc": "While in sunlight, the dragon has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 17, each creature in a 60-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 35 (10d6) Necrotic damage. *Success:* Half damage. *Failure or\
      \ Success:* A Humanoid reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      ...
      \ the dragon's [Initiative](/Mechanics/CLI/variant-rules/initiative-xphb.md)\
      \ count but acts immediately after the dragon."
    "name": "Shadow Breath (Recharge 5-6)"
"bonus_actions":
  - "desc": "While in [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md), the dragon takes\
      \ the [Hide](/Mechanics/CLI/actions.md#Hide) action."
    "name": "Shadow Stealth"
"regional_effects":
  - "desc": "The region around a shadow dragon's lair is twisted by its presence,\
      ...
      \ normally create [Bright Light](/Mechanics/CLI/variant-rules/bright-light-xphb.md)\
      \ instead create [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md),\
      \ and creatures there have [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ on Dexterity ([Stealth](/Mechanics/CLI/skills.md#Stealth)) checks.  \n\nIf\
