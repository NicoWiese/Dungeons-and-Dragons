...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 22, each creature in an 90-foot-long, 10-foot-wide\
      \ [Line](/Mechanics/CLI/variant-rules/line-area-of-effect-xphb.md). *Failure:*\
      \ 63 (14d8) Acid damage. *Success:* Half damage."
    "name": "Acid Breath (Recharge 5-6)"
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 90-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target can't take Reactions; its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      \ is halved; and it can take either an action or a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md)\
      \ on its turn, not both. This effect lasts until the end of its next turn."
    "name": "Slowing Breath"
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      \ and using Charisma as the spellcasting ability (spell save DC 21):\n\n**At\
      \ will:** [Detect Magic](/Mechanics/CLI/spells/detect-magic-xphb.md), [Mind\
      \ Spike](/Mechanics/CLI/spells/mind-spike-xphb.md) (level 5 version), [Minor\
      \ Illusion](/Mechanics/CLI/spells/minor-illusion-xphb.md), [Shapechange](/Mechanics/CLI/spells/shapechange-xphb.md)\
      \ (Beast or Humanoid form only, no [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md)\
      \ gained from the spell, and no Concentration or [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient copper dragon's lair is changed\
      ...
      \ on a [D20 Test](/Mechanics/CLI/variant-rules/d20-test-xphb.md), it must succeed\
      \ on a DC 15 Wisdom saving throw or have the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 21, one creature the dragon can see within\
      ...
      \ subtracts the number rolled from the [D20 Test](/Mechanics/CLI/variant-rules/d20-test-xphb.md).\
  ...
  - "desc": "The dragon uses Spellcasting to cast [Mind Spike](/Mechanics/CLI/spells/mind-spike-xphb.md)\
      ...
      \ of its next turn."
    "name": "Mind Jolt"
  - "desc": "The dragon moves up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
