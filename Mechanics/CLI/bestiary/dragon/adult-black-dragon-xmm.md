...
"regional_effects":
  - "desc": "The region containing an adult or ancient black dragon's lair is warped\
      ...
      \ area [Lightly Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md).\
      ...
      \ succeed on a DC 15 Constitution saving throw or have the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
...
"legendary_actions":
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the dragon can see within\
      \ 120 feet. *Failure:* 22 (4d10) Poison damage, and the target has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      \ on saving throws to maintain [Concentration](/Mechanics/CLI/conditions.md#Concentration)\
  ...
  - "desc": "The dragon can move up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
