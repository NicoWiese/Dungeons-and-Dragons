...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 23, each creature in a 30-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target is pushed up to 60 feet straight away from the dragon\
      \ and has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition."
...
"regional_effects":
  - "desc": "The region containing an adult or ancient bronze dragon's lair is changed\
      ...
      \ Creatures within 1 mile of the lair that lack a [Swim Speed](/Mechanics/CLI/variant-rules/swim-speed-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 20-foot-radius\
      ...
      \ damage, and the target has the [Deafened](/Mechanics/CLI/conditions.md#Deafened)\
