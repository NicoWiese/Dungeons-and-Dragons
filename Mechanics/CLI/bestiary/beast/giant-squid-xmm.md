...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 15 ft. *Hit:* 19 (3d8 + 6) Bludgeoning\
      \ damage. If the target is a Huge or smaller creature, it has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
...
"reactions":
  - "desc": "Trigger: The squid takes damage while underwater. _Response:_ The squid\
      \ releases ink that fills a 15-foot [Cube](/Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md)\
      \ centered on itself, and the squid moves up to its [Swim Speed](/Mechanics/CLI/variant-rules/swim-speed-xphb.md).\
      \ The [Cube](/Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md) is [Heavily\
      \ Obscured](/Mechanics/CLI/variant-rules/heavily-obscured-xphb.md) for 1 minute\
