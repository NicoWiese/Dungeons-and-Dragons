...
"cr": "1/8"
"traits":
  - "desc": "The hawk has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Piercing damage,\
      \ or 6 (1d8 + 2) Piercing damage if the target is [Bloodied](/Mechanics/CLI/conditions.md#Bloodied)."
    "name": "Beak"
"source":
  - "XMM"
