...
"traits":
  - "desc": "The frog can breathe air and water."
    "name": "Amphibious"
  - "desc": "The frog's [Long Jump](/Mechanics/CLI/variant-rules/long-jump-xphb.md)\
      \ is up to 20 feet and its [High Jump](/Mechanics/CLI/variant-rules/high-jump-xphb.md)\
...
"actions":
  ...
  - "desc": "The frog swallows a Small or smaller target it is grappling. While swallowed,\
      \ the target isn't [Grappled](/Mechanics/CLI/conditions.md#Grappled) but has\
      \ the [Blinded](/Mechanics/CLI/conditions.md#Blinded) and [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ conditions, and it has [Total Cover](/Mechanics/CLI/variant-rules/cover-xphb.md)\
      ...
      \ longer [Restrained](/Mechanics/CLI/conditions.md#Restrained) and can escape\
      \ from the corpse using 5 feet of movement, exiting with the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      ...
      \ causing it to exit [Prone](/Mechanics/CLI/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "XMM"
