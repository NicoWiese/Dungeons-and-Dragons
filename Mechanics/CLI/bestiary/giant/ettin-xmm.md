...
"gear":
  - "[battleaxe](/Mechanics/CLI/items/battleaxe-xphb.md)"
  - "[morningstar](/Mechanics/CLI/items/morningstar-xphb.md)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 14 (2d8 + 5) Piercing damage,\
      \ and the target has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
