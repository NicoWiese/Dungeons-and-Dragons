...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +14, range 500 ft. *Hit:* 22 (2d12 + 9) Lightning\
      \ damage, and the target has the [Blinded](/Mechanics/CLI/conditions.md#Blinded)\
      \ and [Deafened](/Mechanics/CLI/conditions.md#Deafened) conditions until the\
      \ start of the giant's next turn."
    "name": "Thunderbolt"
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 10-foot-radius, 40-foot-high\
      \ [Cylinder](/Mechanics/CLI/variant-rules/cylinder-area-of-effect-xphb.md) originating\
