...
"reactions":
  - "desc": "Trigger: A creature the cyclops can see makes an attack roll against\
      \ it. _Response:_ The cyclops imposes [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      \ on the roll, and the cyclops gains [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
