...
"actions":
  ...
  - "desc": "The gnoll targets another creature it can see within 60 feet of itself\
      \ that has the Rampage [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md).\
      \ The target can take a [Reaction](/Mechanics/CLI/variant-rules/reaction-xphb.md)\
