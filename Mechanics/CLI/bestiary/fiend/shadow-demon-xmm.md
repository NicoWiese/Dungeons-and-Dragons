...
"traits":
  - "desc": "If the demon dies outside the Abyss, its body dissolves into ichor, and\
      \ it gains a new body instantly, reviving with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "While in [Bright Light](/Mechanics/CLI/variant-rules/bright-light-xphb.md),\
      \ the demon has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md), the demon takes\
