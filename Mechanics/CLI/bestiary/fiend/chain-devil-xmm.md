...
"senses": "[Darkvision](/Mechanics/CLI/senses.md#Darkvision) 120 ft. (unimpeded by\
  \ magical [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md)), passive Perception\
  \ 11"
...
"traits":
  ...
  - "desc": "The devil has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 10 ft. *Hit:* 11 (2d6 + 4) Slashing damage.\
      ...
      \ condition (escape DC 14) from one of two chains, and it has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
  ...
  - "desc": "The devil conjures a fiery chain to bind a creature. *Dexterity Saving\
      ...
      \ (2d4 + 4) Fire damage, and the target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
...
"reactions":
  - "desc": "Trigger: A creature the devil can see starts its turn within 30 feet\
      ...
      \ the triggering creature. *Failure:* The target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened)\
