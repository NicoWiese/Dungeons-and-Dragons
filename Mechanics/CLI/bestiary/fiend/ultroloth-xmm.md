...
"traits":
  ...
  - "desc": "The ultroloth has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 15 ft. *Hit:* 25 (6d6 + 4) Force damage,\
    ...
    "name": "Mercurial Whip"
  - "desc": "*Wisdom Saving Throw:* DC 17, each creature in a 30-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 10 (3d6) Psychic damage, and the target has the [Stunned](/Mechanics/CLI/conditions.md#Stunned)\
