...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 4 (1d6 + 1) Slashing damage."
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 11, each creature in a 10-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the dretch. *Failure:* The target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
      \ condition until the end of its next turn. While [Poisoned](/Mechanics/CLI/conditions.md#Poisoned),\
      \ the creature can take either an action or a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md)\
