...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +6, reach 5 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Abyssal Strike"
  - "desc": "The gnoll conjures a 30-foot [Cube](/Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md)\
      \ of magical [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md) originating\
      \ from a point it can see within 60 feet, which lasts for 1 minute or until\
      \ the gnoll's [Concentration](/Mechanics/CLI/conditions.md#Concentration) ends\
      \ on it. This area is [Difficult Terrain](/Mechanics/CLI/variant-rules/difficult-terrain-xphb.md).\
      ...
      \ Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md). *Success:*\
      \ Half damage only."
    "name": "Hunger of Yeenoghu (Recharge 5-6)"
"bonus_actions":
  - "desc": "Immediately after dealing damage to a creature that is already [Bloodied](/Mechanics/CLI/conditions.md#Bloodied),\
      \ the gnoll moves up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
