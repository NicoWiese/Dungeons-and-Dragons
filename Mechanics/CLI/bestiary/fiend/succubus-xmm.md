...
"cr": "4"
"traits":
  - "desc": "When the succubus finishes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md),\
...
"actions":
  ...
  - "desc": "The succubus casts [Dominate Person](/Mechanics/CLI/spells/dominate-person-xphb.md)\
    ...
    "name": "Charm"
  - "desc": "*Constitution Saving Throw:* DC 15, one creature [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
      \ by the succubus within 5 feet. *Failure:* 13 (3d8) Psychic damage. *Success:*\
      \ Half damage. *Failure or Success:* The target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "The succubus shape-shifts to resemble a Medium or Small Humanoid or back\
      ...
      \ its [Fly Speed](/Mechanics/CLI/variant-rules/fly-speed-xphb.md) is available\
