...
"traits":
  - "desc": "If the erinyes dies outside the Nine Hells, its body disappears in sulfurous\
      \ smoke, and it gains a new body instantly, reviving with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ somewhere in the Nine Hells."
    "name": "Diabolical Restoration"
  - "desc": "The erinyes has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The erinyes has a magic rope. While bearing it, the erinyes can use the\
      \ Entangling Rope action. The rope has AC 20, HP 90, and [Immunity](/Mechanics/CLI/variant-rules/immunity-xphb.md)\
      \ to Poison and Psychic damage. The rope turns to dust if reduced to 0 [Hit\
      \ Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md), if it is 5+ feet\
      ...
      \ [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md) or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md)."
    "name": "Magic Rope"
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 16, one creature the erinyes can see within\
      \ 120 feet. *Failure:* 14 (4d6) Force damage, and the target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition until the rope is destroyed, the erinyes uses a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md)\
