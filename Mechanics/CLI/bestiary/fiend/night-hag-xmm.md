...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed)"
...
"traits":
  ...
  - "desc": "The hag has a soul bag. While holding or carrying the bag, the hag can\
      \ use its Nightmare Haunting action.\n\nThe bag has AC 15, HP 20, and [Resistance](/Mechanics/CLI/variant-rules/resistance-xphb.md)\
      \ to all damage. The bag turns to dust if reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "While on the Ethereal Plane, the hag casts [Dream](/Mechanics/CLI/spells/dream-xphb.md),\
      ...
      \ spell, the target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
