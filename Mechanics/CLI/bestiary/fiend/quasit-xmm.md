...
"cr": "1"
"traits":
  - "desc": "The quasit has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 10, one creature within 20 feet. *Failure:*\
      \ The target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened) condition.\
      \ At the end of each of its turns, the target repeats the save, ending the effect\
      \ on itself on a success. After 1 minute, it succeeds automatically."
    "name": "Scare (1/Day)"
  - "desc": "The quasit shape-shifts to resemble a bat ([Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      ...
      \ same in each form, except for its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md).\
