...
"condition_immunities": "[frightened](/Mechanics/CLI/conditions.md#Frightened), [poisoned](/Mechanics/CLI/conditions.md#Poisoned)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 10 ft. *Hit:* 8 (1d10 + 3) Slashing damage.\
      ...
      \ loses 5 (1d10) [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ at the start of each of its turns. The wound closes after 1 minute, after\
      \ a spell restores [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ to the target, or after the target or a creature within 5 feet of it takes\
      \ an action to stanch the wound, doing so by succeeding on a DC 12 Wisdom ([Medicine](/Mechanics/CLI/skills.md#Medicine))\
      \ check."
