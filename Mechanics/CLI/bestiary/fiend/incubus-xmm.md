...
"cr": "4"
"traits":
  - "desc": "When the incubus finishes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md),\
...
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the incubus can see within\
      \ 60 feet. *Failure:* If the target has 20 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ or fewer, it has the [Unconscious](/Mechanics/CLI/conditions.md#Unconscious)\
