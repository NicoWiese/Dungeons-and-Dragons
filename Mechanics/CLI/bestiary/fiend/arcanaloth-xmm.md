...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed), [poisoned](/Mechanics/CLI/conditions.md#Poisoned)"
...
"traits":
  - "desc": "If the arcanaloth dies outside Gehenna, its body dissolves into ichor,\
      \ and it gains a new body instantly and revives with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ in Gehenna."
    "name": "Fiendish Restoration"
  - "desc": "The arcanaloth has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The arcanaloth has a magic tome. While holding or carrying the tome,\
      ...
      \ 35; and [Immunity](/Mechanics/CLI/variant-rules/immunity-xphb.md) to Necrotic,\
      \ Poison, and Psychic damage. The tome regains all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      ...
      \ create a new one when it finishes a [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md)."
    "name": "Soul Tome"
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (2d4 + 5) Slashing damage\
      ...
      \ has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated) condition.\
      ...
      \ tome and can escape only if the tome is reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
