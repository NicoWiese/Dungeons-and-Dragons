...
"traits":
  ...
  - "desc": "If the rakshasa dies outside the Nine Hells, its body turns to ichor,\
      \ and it gains a new body instantly, reviving with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ While cursed, the target gains no benefit from finishing a [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md)."
    "name": "Cursed Touch"
  - "desc": "*Wisdom Saving Throw:* DC 18, each enemy in a 30-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the rakshasa. *Failure:* 28 (8d6) Psychic damage, and the\
      \ target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened) and [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
