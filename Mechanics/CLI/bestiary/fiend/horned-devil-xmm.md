...
"senses": "[Darkvision](/Mechanics/CLI/senses.md#Darkvision) 150 ft. (unimpeded by\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 17, one creature the devil can see within\
      ...
      \ 10 (3d6) [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) at\
      \ the start of each of its turns. The wound closes after 1 minute, after a spell\
      \ restores [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) to\
      \ the target, or after the target or a creature within 5 feet of it takes an\
      \ action to stanch the wound, doing so by succeeding on a DC 17 Wisdom ([Medicine](/Mechanics/CLI/skills.md#Medicine))\
      \ check."
    "name": "Infernal Tail"
"source":
  - "XMM"
