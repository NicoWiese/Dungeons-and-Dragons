...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 20-foot-radius,\
      \ 40-foot-high [Cylinder](/Mechanics/CLI/variant-rules/cylinder-area-of-effect-xphb.md)\
      \ centered on a point the lizardfolk can see within 60 feet. *Failure:* 15 (6d4)\
      \ Bludgeoning damage, and the target has the [Prone](/Mechanics/CLI/conditions.md#Prone)\
