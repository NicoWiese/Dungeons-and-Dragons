...
"condition_immunities": "[blinded](/Mechanics/CLI/conditions.md#Blinded), [charmed](/Mechanics/CLI/conditions.md#Charmed),\
  \ [deafened](/Mechanics/CLI/conditions.md#Deafened), [exhaustion](/Mechanics/CLI/conditions.md#Exhaustion),\
  \ [frightened](/Mechanics/CLI/conditions.md#Frightened), [grappled](/Mechanics/CLI/conditions.md#Grappled),\
...
"senses": "[Truesight](/Mechanics/CLI/senses.md#Truesight) 150 ft., passive Perception\
  \ 12"
...
"actions":
  ...
  - "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
      ...
      \ a 60-foot-radius [Sphere](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ Waves.** *Strength Saving Throw:* DC 23, each creature in a 90-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 22 (5d8) Bludgeoning damage plus 22 (5d8) Cold damage, and the\
      \ target has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition. *Success:*\
      \ Half damage only. *Failure or Success:* The target's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      \ is reduced to 0 until the end of its next turn.  \n- **3 Raging Storm.** A\
      \ storm cloud fills a 60-foot-radius [Sphere](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ entirely in the cloud have the [Blinded](/Mechanics/CLI/conditions.md#Blinded)\
      \ and [Deafened](/Mechanics/CLI/conditions.md#Deafened) conditions and can't\
      ...
      \ DC 23, each creature in a 90-foot [Cube](/Mechanics/CLI/variant-rules/cube-area-of-effect-xphb.md)\
      \ originating from a point on the ground within 150 feet. *Failure:* 18 (4d8)\
      \ Bludgeoning damage plus 18 (4d8) Acid damage, and the target has the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      \ condition and is buried under rubble. A buried target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition, has [Total Cover](/Mechanics/CLI/variant-rules/cover-xphb.md),\
      \ and is suffocating. As an action, a buried creature or another creature within\
      \ 5 feet of it can make a DC 18 Strength ([Athletics](/Mechanics/CLI/skills.md#Athletics))\
...
"legendary_actions":
  - "desc": "The cataclysm makes one Elemental Burst attack."
    "name": "Eruption"
  - "desc": "The cataclysm moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
      \ [Fly Speed](/Mechanics/CLI/variant-rules/fly-speed-xphb.md), or [Swim Speed](/Mechanics/CLI/variant-rules/swim-speed-xphb.md)\
      ...
      \ target has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition. *Failure\
