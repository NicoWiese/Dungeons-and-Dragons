...
"traits":
  - "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
      \ choice in a 10-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the salamander takes 10 (3d6) Fire damage."
    "name": "Fire Aura"
  - "desc": "The salamander has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +12, reach 5 ft. or range 30/90 ft. *Hit:*\
      ...
      \ attack."
    "name": "Flame Trident"
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 30-foot-radius [Sphere](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ normal [burning](/Mechanics/CLI/traps-hazards/burning-xphb.md) damage. The\
      \ target gains 1 [Exhaustion](/Mechanics/CLI/conditions.md#Exhaustion) level\
      \ whenever it takes this [burning](/Mechanics/CLI/traps-hazards/burning-xphb.md)\
      \ damage. *Success:* Half damage only."
    "name": "Inferno Blast (Recharge 5-6)"
"bonus_actions":
  - "desc": "The salamander moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      \ without provoking [Opportunity Attacks](/Mechanics/CLI/actions.md#Opportunity%20Attack).\
      \ During this movement, fire fills a 5-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the salamander. When the [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
