...
"traits":
  - "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
      \ choice in a 5-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Large or smaller creature the salamander\
      ...
      \ (2d6) Fire damage. The target has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
