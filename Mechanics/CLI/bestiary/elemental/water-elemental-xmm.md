...
"cr": "5"
"traits":
  - "desc": "If the elemental takes Cold damage, its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Bludgeoning\
      \ damage. If the target is a Medium or smaller creature, it has the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      \ condition."
    "name": "Slam"
  - "desc": "*Strength Saving Throw:* DC 15, each creature in the elemental's space.\
      ...
      \ (escape DC 14). Until the grapple ends, the target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      ...
      \ creature out of it by succeeding on a DC 14 Strength ([Athletics](/Mechanics/CLI/skills.md#Athletics))\
