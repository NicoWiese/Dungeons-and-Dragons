...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 6 (2d4 + 1) Slashing damage,\
      \ and the target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened)\
  ...
  - "desc": "*Wisdom Saving Throw:* DC 11, one creature the scarecrow can see within\
      ...
      \ condition until the end of the scarecrow's next turn. While [Frightened](/Mechanics/CLI/conditions.md#Frightened),\
