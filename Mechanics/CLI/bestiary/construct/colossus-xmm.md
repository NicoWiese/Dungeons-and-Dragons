...
"senses": "[Truesight](/Mechanics/CLI/senses.md#Truesight) 300 ft., passive Perception\
  \ 10"
...
"traits":
  ...
  - "desc": "The colossus has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +18, range 300 ft. *Hit:* 22 (4d10) Radiant damage.\
      \ If the target is a Large or smaller creature, it has the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      \ condition."
    "name": "Radiant Ray"
  - "desc": "*Dexterity Saving Throw:* DC 26, each creature in a 300-foot-long, 10-foot-wide\
      ...
      \ creature reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"legendary_actions":
  - "desc": "The colossus makes one Radiant Ray attack."
    "name": "Smite"
  - "desc": "The colossus moves up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
