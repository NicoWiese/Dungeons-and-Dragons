...
"traits":
  - "desc": "Whenever the golem is subjected to Acid damage, it takes no damage and\
      \ instead regains a number of [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "Whenever the golem starts its turn [Bloodied](/Mechanics/CLI/conditions.md#Bloodied),\
      ...
      \ longer [Bloodied](/Mechanics/CLI/conditions.md#Bloodied)."
    "name": "Berserk"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (1d10 + 5) Bludgeoning\
      \ damage plus 6 (1d12) Acid damage, and the target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the Acid damage taken."
    "name": "Slam"
"bonus_actions":
  - "desc": "The golem takes the [Dash](/Mechanics/CLI/actions.md#Dash) and [Disengage](/Mechanics/CLI/actions.md#Disengage)\
      \ actions."
