...
"condition_immunities": "[exhaustion](/Mechanics/CLI/conditions.md#Exhaustion), [petrified](/Mechanics/CLI/conditions.md#Petrified)"
"senses": "[Darkvision](/Mechanics/CLI/senses.md#Darkvision) 60 ft., passive Perception\
  \ 20"
"languages": ""
"cr": "9"
"traits":
  - "desc": "At the end of each of the gorgon's turns, each creature in a 5-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the gorgon takes 13 (3d8) Fire damage."
    "name": "Flame Aura"
  - "desc": "The gorgon sheds [Bright Light](/Mechanics/CLI/variant-rules/bright-light-xphb.md)\
      \ in a 10-foot radius and [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 5 ft. *Hit:* 11 (2d6 + 4) Piercing damage\
    ...
    "name": "Gore"
  - "desc": "The gorgon moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      ...
      \ and the target is pulled into the gorgon's space and has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ condition (escape DC 14); if the gorgon already has a creature [Grappled](/Mechanics/CLI/conditions.md#Grappled),\
      \ the target has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition instead.\
      \ Until the grapple ends, the target has the [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition. When the gorgon moves, the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
