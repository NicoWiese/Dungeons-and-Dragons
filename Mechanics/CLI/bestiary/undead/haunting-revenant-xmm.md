...
"traits":
  ...
  - "desc": "If the revenant dies, it revives 24 hours later unless [Dispel Evil and\
      ...
      \ block and returns with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
    "name": "Undead Restoration"
"actions":
  - "desc": "The revenant makes two Object Slam attacks and uses Invitation."
    "name": "Multiattack"
  - "desc": "*Melee  or Ranged Attack Roll:* +9 (with [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
      \ if the target is inside the revenant's space), reach 10 ft. or range 30/90\
      \ ft. *Hit:* 27 (5d8 + 5) Bludgeoning damage."
    "name": "Object Slam"
  - "desc": "*Charisma Saving Throw:* DC 17, each creature in a 60-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target is teleported inside the revenant's space and swallowed.\
      \ A swallowed creature has [Total Cover](/Mechanics/CLI/variant-rules/cover-xphb.md)\
      \ against attacks and other effects outside the revenant.\n\nWhile the revenant\
      \ has [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md), a swallowed\
      \ creature can leave the revenant's space only by using magic that enables planar\
      \ travel, such as the [Plane Shift](/Mechanics/CLI/spells/plane-shift-xphb.md)\
      \ spell."
    "name": "Invitation"
"source":
  - "XMM"
