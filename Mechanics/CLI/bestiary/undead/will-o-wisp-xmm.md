...
"condition_immunities": "[exhaustion](/Mechanics/CLI/conditions.md#Exhaustion), [grappled](/Mechanics/CLI/conditions.md#Grappled),\
...
"traits":
  - "desc": "The wisp can't wear or carry anything."
    "name": "Ephemeral"
  - "desc": "The wisp sheds [Bright Light](/Mechanics/CLI/variant-rules/bright-light-xphb.md)\
      \ in a 20-foot radius and [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 10, one living creature the wisp can\
      \ see within 5 feet that has 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md).\
      \ *Failure:* The target dies, and the wisp regains 10 (3d6) [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
    "name": "Consume Life"
  - "desc": "The wisp and its light have the [Invisible](/Mechanics/CLI/conditions.md#Invisible)\
      \ condition until the wisp's [Concentration](/Mechanics/CLI/conditions.md#Concentration)\
