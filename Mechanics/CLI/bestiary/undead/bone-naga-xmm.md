...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, one creature the naga can see within 60\
      \ feet. *Failure:* 13 (3d6 + 3) Psychic damage, and the target has the [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
  ...
  - "desc": "The naga casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Mage Hand](/Mechanics/CLI/spells/mage-hand-xphb.md), [Thaumaturgy](/Mechanics/CLI/spells/thaumaturgy-xphb.md)\n\
      \n**1/day each:** [Command](/Mechanics/CLI/spells/command-xphb.md), [Detect\
      \ Thoughts](/Mechanics/CLI/spells/detect-thoughts-xphb.md), [Lightning Bolt](/Mechanics/CLI/spells/lightning-bolt-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
