...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      ...
      \ has 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) in mist\
      ...
      \ vampire form and has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
      \ condition until it regains any [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md),\
      \ and it regains 1 [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The vampire has these weaknesses:\n\n- **Forbiddance.** The vampire can't\
      ...
      \ the vampire's heart while the vampire has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
      \ condition in its resting place, the vampire has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
      ...
      \ has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md) on attack\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 8 (1d8 + 4) Bludgeoning damage\
      ...
      \ it has the [Grappled](/Mechanics/CLI/conditions.md#Grappled) condition (escape\
  ...
  - "desc": "*Constitution Saving Throw:* DC 17, one creature within 5 feet that is\
      \ willing or that has the [Grappled](/Mechanics/CLI/conditions.md#Grappled),\
      \ [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated), or [Restrained](/Mechanics/CLI/conditions.md#Restrained)\
      \ condition. *Failure:* 6 (1d4 + 4) Piercing damage plus 13 (3d8) Necrotic damage.\
      \ The target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the Necrotic damage taken, and the\
      \ vampire regains [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ equal to that amount. A Humanoid reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
      \ a Tiny bat ([Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) 5 ft., [Fly\
      \ Speed](/Mechanics/CLI/variant-rules/fly-speed-xphb.md) 30 ft.) or a Medium\
      \ cloud of mist ([Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) 5 ft.,\
      \ [Fly Speed](/Mechanics/CLI/variant-rules/fly-speed-xphb.md) 20 ft. [hover]),\
      ...
      \ than its size and [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md), are\
      ...
      \ pass through liquid. It has [Resistance](/Mechanics/CLI/variant-rules/resistance-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing a vampire's lair is warped by its presence, creating\
      ...
      \ smaller Beasts have the [Charmed](/Mechanics/CLI/conditions.md#Charmed) condition\
      ...
      \ of the lair is [Lightly Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md)\
...
"legendary_actions":
  - "desc": "The vampire moves up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
