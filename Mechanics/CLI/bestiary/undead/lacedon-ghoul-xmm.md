...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 9 (2d6 + 2) Cold damage,\
      \ and the target's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) decreases\
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Slashing damage.\
      ...
      \ has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed) condition until\
      \ the end of its next turn."
    "name": "Claw"
"bonus_actions":
  - "desc": "While underwater, the ghoul moves up to half its [Swim Speed](/Mechanics/CLI/variant-rules/swim-speed-xphb.md)\
