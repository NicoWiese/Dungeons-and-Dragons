...
"gear":
  - "[component pouch](/Mechanics/CLI/items/component-pouch-xphb.md)"
...
"traits":
  ...
  - "desc": "If destroyed, the lich reforms in 1d10 days if it has a spirit jar, reviving\
      \ with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +12, reach 5 ft. *Hit:* 15 (3d6 + 5) Cold damage,\
      \ and the target has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
  ...
  - "desc": "The lich casts one of the following spells, using Intelligence as the\
      ...
      \ [Detect Thoughts](/Mechanics/CLI/spells/detect-thoughts-xphb.md), [Dispel\
      \ Magic](/Mechanics/CLI/spells/dispel-magic-xphb.md), [Fireball](/Mechanics/CLI/spells/fireball-xphb.md)\
      \ (level 5 version), [Invisibility](/Mechanics/CLI/spells/invisibility-xphb.md),\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 20, each creature that isn't an Undead\
      \ in a 20-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    "name": "Disrupt Life"
  - "desc": "The lich casts [Fear](/Mechanics/CLI/spells/fear-xphb.md), using the\
