...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed), [deafened](/Mechanics/CLI/conditions.md#Deafened),\
  \ [exhaustion](/Mechanics/CLI/conditions.md#Exhaustion), [frightened](/Mechanics/CLI/conditions.md#Frightened),\
...
"traits":
  ...
  - "desc": "If the demilich is destroyed, it reforms and regains all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +11, reach 5 ft. or range 120 ft. *Hit:*\
    ...
    "name": "Necrotic Burst"
  - "desc": "*Constitution Saving Throw:* DC 19, each creature in a 30-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the demilich. *Failure:* 70 (20d6) Psychic damage. *Failure\
      \ or Success:* The target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened)\
...
"regional_effects":
  - "desc": "The region containing a demilich's lair is twisted by its presence, creating\
      ...
      \ than the demilich or one of its allies finishes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md)\
      \ within 1 mile of the lair, the creature must succeed on a DC 20 Constitution\
      \ saving throw or have its [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ maximum reduced by 1d4. This reduction lasts until the creature finishes a\
      \ [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md) outside that area.\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 19, one creature the demilich can see\
      \ within 120 feet. *Failure:* The target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by 14 (4d6). *Failure or Success:* The demilich can't take\
      \ this action again until the start of its next turn."
    "name": "Energy Drain"
  - "desc": "The demilich flies up to its [Fly Speed](/Mechanics/CLI/variant-rules/fly-speed-xphb.md),\
      ...
      \ 19. *Failure:* The target has the [Blinded](/Mechanics/CLI/conditions.md#Blinded)\
