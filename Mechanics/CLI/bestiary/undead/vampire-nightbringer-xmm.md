...
"traits":
  - "desc": "The vampire takes 10 Radiant damage if it starts its turn in sunlight.\
      \ While in sunlight, it has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 7 (1d6 + 4) Piercing damage\
      \ plus 10 (3d6) Necrotic damage. The target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md), the vampire\
      \ takes the [Hide](/Mechanics/CLI/actions.md#Hide) action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
