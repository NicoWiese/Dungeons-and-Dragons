...
"traits":
  - "desc": "The shadow can move through a space as narrow as 1 inch without expending\
    ...
    "name": "Amorphous"
  - "desc": "While in sunlight, the shadow has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      \ on [D20 Tests](/Mechanics/CLI/variant-rules/d20-test-xphb.md)."
...
"bonus_actions":
  - "desc": "While in [Dim Light](/Mechanics/CLI/variant-rules/dim-light-xphb.md)\
      \ or [Darkness](/Mechanics/CLI/variant-rules/darkness-xphb.md), the shadow takes\
