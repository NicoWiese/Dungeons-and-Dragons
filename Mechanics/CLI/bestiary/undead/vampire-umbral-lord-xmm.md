...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      ...
      \ inside its resting place, it has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
      \ condition for 1 hour, after which it regains 1 [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
    "name": "Shadow Escape"
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +10, range 120 ft. *Hit:* 16 (2d10 + 5) Necrotic\
      \ damage, and the target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
...
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the vampire can see\
      ...
      \ damage. The target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the damage taken, and the vampire\
      \ regains [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) equal\
      \ to that amount."
    "name": "Sanguine Drain"
"regional_effects":
