...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, each creature in a 60-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md)\
  ...
  - "desc": "*Charisma Saving Throw:* DC 13, one Humanoid the ghost can see within\
      ...
      \ and the target has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
      ...
      \ game statistics are the same, except it uses the possessed target's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
      \ as well as the target's Strength, Dexterity, and Constitution modifiers.\n\
      \nThe possession lasts until the body drops to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ or the ghost leaves as a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md).\
      \ When the possession ends, the ghost appears in an unoccupied space within\
      \ 5 feet of the target, and the target is immune to this ghost's [Possession](/Mechanics/CLI/variant-rules/possession-xphb.md)\
      \ for 24 hours. *Success:* The target is immune to this ghost's [Possession](/Mechanics/CLI/variant-rules/possession-xphb.md)\
      \ for 24 hours."
