...
"senses": "[Blindsight](/Mechanics/CLI/senses.md#Blindsight) 60 ft., [Darkvision](/Mechanics/CLI/senses.md#Darkvision)\
...
"traits":
  ...
  - "desc": "Creatures within 60 feet of the dracolich can't regain [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
    "name": "Life Suppression"
  - "desc": "The dracolich has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The dracolich has a magical gem. If the dracolich is destroyed while\
      ...
      \ body in 1d20 days, regaining all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ and appearing within 5 feet of the gem.\n\nThe gem is a Tiny object that has\
      \ AC 20; HP 50; and [Immunity](/Mechanics/CLI/variant-rules/immunity-xphb.md)\
      \ to Necrotic, Poison, and Psychic damage. The gem regains all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ at the end of every turn, but it turns to dust if reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +13, reach 10 ft. *Hit:* 18 (2d10 + 7) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 60-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The dracolich casts one of the following spells, requiring no Material\
      ...
      \ [Ray of Sickness](/Mechanics/CLI/spells/ray-of-sickness-xphb.md) (level 2\
...
"regional_effects":
  - "desc": "The region containing a dracolich's lair is warped by its presence, creating\
      ...
      \ lair is [Lightly Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md)\
      \ by pale fog. Whenever a creature other than the dracolich or one of its allies\
      \ finishes a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md) in\
      \ that area, it must succeed on a DC 15 Constitution saving throw or gain 1\
      \ [Exhaustion](/Mechanics/CLI/conditions.md#Exhaustion) level.  \n- **Soul Drain.**\
      \ Creatures within 1 mile of the lair have [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      \ on [Death Saving Throws](/Mechanics/CLI/variant-rules/death-saving-throw-xphb.md).\
...
"legendary_actions":
  - "desc": "The dracolich moves up to half its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md),\
  ...
  - "desc": "The dracolich uses Spellcasting to cast [Ray of Sickness](/Mechanics/CLI/spells/ray-of-sickness-xphb.md)\
      ...
      \ of its next turn."
    "name": "Sickening Ray"
  - "desc": "*Wisdom Saving Throw:* DC 19, each creature in a 30-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the dracolich. *Failure:* 11 (2d10) Psychic damage, and the\
      \ target has the [Frightened](/Mechanics/CLI/conditions.md#Frightened) condition\
