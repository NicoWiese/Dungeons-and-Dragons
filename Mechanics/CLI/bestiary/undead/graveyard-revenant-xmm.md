...
"condition_immunities": "[charmed](/Mechanics/CLI/conditions.md#Charmed), [exhaustion](/Mechanics/CLI/conditions.md#Exhaustion),\
  ...
  \ [stunned](/Mechanics/CLI/conditions.md#Stunned), [unconscious](/Mechanics/CLI/conditions.md#Unconscious)"
...
"traits":
  - "desc": "If the revenant dies, it revives 24 hours later unless [Dispel Evil and\
      ...
      \ returns with all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 10 (1d10 + 5) Bludgeoning\
      ...
      \ creature, it has the [Grappled](/Mechanics/CLI/conditions.md#Grappled) condition\
      \ (escape DC 15). Until the grapple ends, the target is suffocating. The revenant\
      \ can have up to two targets [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ in this way at a time."
    "name": "Suffocate"
  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 30-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the revenant. *Failure:* The target has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
