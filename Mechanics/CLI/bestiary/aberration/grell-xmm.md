...
"condition_immunities": "[blinded](/Mechanics/CLI/conditions.md#Blinded), [prone](/Mechanics/CLI/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 10 ft. *Hit:* 7 (1d10 + 2) Piercing damage.\
      ...
      \ target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned) condition\
      \ and repeats the save at the end of each of its turns, ending the effect on\
      \ itself on a success. After 1 minute, it succeeds automatically. While [Poisoned](/Mechanics/CLI/conditions.md#Poisoned),\
