...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 12 (2d6 + 5) Slashing damage\
      ...
      \ *Failure:* The target is cursed. The cursed target can't regain [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md),\
      ...
      \ finishing a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md). If\
      \ the curse reduces the target's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
