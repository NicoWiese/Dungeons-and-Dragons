...
"cr": "2"
"traits":
  - "desc": "The ground in a 10-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the mouther is [Difficult Terrain](/Mechanics/CLI/variant-rules/difficult-terrain-xphb.md)."
    "name": "Aberrant Ground"
  - "desc": "The mouther babbles incoherently while it doesn't have the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
      ...
      \ Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md) and uses all its\
...
"actions":
  - "desc": "*Melee Attack Roll:* +2, reach 5 ft. *Hit:* 7 (2d6) Piercing damage.\
      \ If the target is a Medium or smaller creature, it has the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      \ condition. The target dies if it is reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ by this attack. Its body is then absorbed into the mouther, leaving only equipment\
      \ behind."
    "name": "Bite"
  - "desc": "*Dexterity Saving Throw:* DC 10, each creature in a 10-foot-radius [Sphere](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md)\
      \ centered on a point within 30 feet. *Failure:* 7 (2d6) Radiant damage, and\
      \ the target has the [Blinded](/Mechanics/CLI/conditions.md#Blinded) condition\
