...
"skillsaves":
  - "name": "[Perception](/Mechanics/CLI/skills.md#Perception)"
    "desc": "+12"
"condition_immunities": "[prone](/Mechanics/CLI/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "The beholder randomly shoots one of the following magical rays at a target\
      ...
      \ [Charmed](/Mechanics/CLI/conditions.md#Charmed) condition for 1 hour or until\
      \ it takes damage. *Success:* Half damage only.  \n- **2 Paralyzing Ray.** *Constitution\
      \ Saving Throw:* DC 16. *Failure:* The target has the [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed)\
      ...
      \ Necrotic damage. Until the end of the target's next turn, the target's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      \ is halved; the target can't take Reactions; and it can take either an action\
      \ or a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md) on\
      ...
      \ the [Restrained](/Mechanics/CLI/conditions.md#Restrained) condition until\
      \ the start of the beholder's next turn or until the beholder has the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated)\
      ...
      \ it is a Construct or an Undead). *Failure:* The target has the [Unconscious](/Mechanics/CLI/conditions.md#Unconscious)\
      ...
      \ Disintegration Ray.** *Dexterity Saving Throw:* DC 16. *Failure:* 36 (8d8)\
    ...
    "name": "Eye Rays"
"bonus_actions":
  - "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md).\
...
"regional_effects":
  - "desc": "The region containing a beholder's lair is twisted by its presence, creating\
      ...
      \ and its allies) that finishes a [Short Rest](/Mechanics/CLI/variant-rules/short-rest-xphb.md)\
      ...
      \ 1 mile of the lair that makes a [D20 Test](/Mechanics/CLI/variant-rules/d20-test-xphb.md)\
      \ and rolls a 1 has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition.\
