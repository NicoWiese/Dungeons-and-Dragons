...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 10 (2d6 + 3) Piercing damage.\
      ...
      \ final 24 hours, the cursed target feels unwell; its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md)\
      \ is halved, and it has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md)\
      \ on [D20 Tests](/Mechanics/CLI/variant-rules/d20-test-xphb.md). At the end\
