...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +8, reach 5 ft. or range 120 ft. *Hit:*\
      ...
      \ (A) the [Charmed](/Mechanics/CLI/conditions.md#Charmed) condition until the\
      \ start of the githzerai's next turn or (B) the [Prone](/Mechanics/CLI/conditions.md#Prone)\
      \ condition, provided the target is a Large or smaller creature."
    "name": "Psychic Warp"
  - "desc": "The githzerai casts one of the following spells, requiring no spell components\
      \ and using Intelligence as the spellcasting ability (spell save DC 16):\n\n\
      **At will:** [Mage Hand](/Mechanics/CLI/spells/mage-hand-xphb.md) (the hand\
