...
"traits":
  ...
  - "desc": "The chuul senses magic within 120 feet of itself. This trait otherwise\
      \ works like the [Detect Magic](/Mechanics/CLI/spells/detect-magic-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 10 ft. *Hit:* 9 (1d10 + 4) Bludgeoning\
    ...
    "name": "Pincer"
  - "desc": "*Constitution Saving Throw:* DC 13, one creature [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ by the chuul. *Failure:* The target has the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. After 1 minute, it succeeds automatically.\
      \ While [Poisoned](/Mechanics/CLI/conditions.md#Poisoned), the target has the\
      \ [Paralyzed](/Mechanics/CLI/conditions.md#Paralyzed) condition."
