...
"traits":
  ...
  - "desc": "If destroyed, the aboleth gains a new body in 5d10 days, reviving with\
      \ all its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) in the\
  ...
  - "desc": "While underwater, the aboleth is surrounded by mucus. *Constitution Saving\
      \ Throw:* DC 14, each creature in a 5-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md)\
      ...
      \ the target can breathe air and water, and it can't regain [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 15 ft. *Hit:* 12 (2d6 + 5) Bludgeoning\
      \ damage. If the target is a Large or smaller creature, it has the [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      \ condition (escape DC 14) from one of four tentacles."
    "name": "Tentacle"
  - "desc": "*Intelligence Saving Throw:* DC 16, one creature within 30 feet that\
      \ is [Charmed](/Mechanics/CLI/conditions.md#Charmed) or [Grappled](/Mechanics/CLI/conditions.md#Grappled)\
      ...
      \ is a Humanoid and is reduced to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)\
      \ by this action."
    "name": "Consume Memories"
  - "desc": "*Wisdom Saving Throw:* DC 16, one creature the aboleth can see within\
      \ 30 feet. *Failure:* The target has the [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
      \ condition until the aboleth dies or is on a different plane of existence from\
      \ the target. While [Charmed](/Mechanics/CLI/conditions.md#Charmed), the target\
...
"regional_effects":
  - "desc": "The region containing an aboleth's lair is warped by it, creating the\
      ...
      \ have the [Poisoned](/Mechanics/CLI/conditions.md#Poisoned) condition for 1\
      \ hour.  \n- **Psionic Projection.** While in its lair, the aboleth can cast\
      \ [Project Image](/Mechanics/CLI/spells/project-image-xphb.md), requiring no\
...
"legendary_actions":
  - "desc": "The aboleth makes one Tentacle attack."
    "name": "Lash"
  - "desc": "If the aboleth has at least one creature [Charmed](/Mechanics/CLI/conditions.md#Charmed)\
      \ or [Grappled](/Mechanics/CLI/conditions.md#Grappled), it uses Consume Memories\
      \ and regains 5 (1d10) [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md)."
    "name": "Psychic Drain"
"source":
  - "XMM"
