...
Each time you issue the "Recruit" order to this facility, its hireling extends an invitation to a [Friendly](/Mechanics/CLI/variant-rules/friendly-attitude-xphb.md) NPC spellcaster. Roll any die. If the number rolled is odd, the invitee declines the invitation, and you gain no benefit from having issued the order. If the number rolled is even, the invitee accepts the invitation and arrives in your Bastion via your Teleportation Circle.
