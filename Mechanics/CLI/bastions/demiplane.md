...
- **Prerequisites**: Ability to use an [Arcane Focus](/Mechanics/CLI/items/arcane-focus-xphb.md) or tool as a [Spellcasting Focus](/Mechanics/CLI/variant-rules/spellcasting-focus-xphb.md)
- **Space**: Vast (36 sq)
- **Hirelings**: 1
- **Order**: empower
