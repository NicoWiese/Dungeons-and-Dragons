...
- **Skill Proficiencies**: Choose 3 [skills](/Mechanics/CLI/skills.md)
...
- **Skill Proficiencies**: Choose 1 [skill](/Mechanics/CLI/skills.md)
...
**Using Bardic Inspiration.** As a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md), you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [D20 Test](/Mechanics/CLI/variant-rules/d20-test-xphb.md), the creature can roll the Bardic Inspiration die and add the number rolled to the `d20`, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.

**Number of Uses.** You can confer a Bardic Inspiration die a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md).
...
**Spell Slots.** The Bard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md).
...
**Spellcasting Focus.** You can use a [Musical Instrument](/Mechanics/CLI/items/musical-instrument-xphb.md) as a [Spellcasting Focus](/Mechanics/CLI/variant-rules/spellcasting-focus-xphb.md) for your Bard spells.

### Expertise (Level 2)

You gain [Expertise](/Mechanics/CLI/variant-rules/expertise-xphb.md) in two of your skill proficiencies of your choice. [Performance](/Mechanics/CLI/skills.md#Performance) and [Persuasion](/Mechanics/CLI/skills.md#Persuasion) are recommended if you have proficiency in them.

At Bard level 9, you gain [Expertise](/Mechanics/CLI/variant-rules/expertise-xphb.md) in two more of your skill proficiencies of your choice.

### Jack of All Trades (Level 2)

You can add half your [Proficiency Bonus](/Mechanics/CLI/variant-rules/proficiency-xphb.md) (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [Proficiency Bonus](/Mechanics/CLI/variant-rules/proficiency-xphb.md).

For example, if you make a Strength ([Athletics](/Mechanics/CLI/skills.md#Athletics)) check and lack [Athletics](/Mechanics/CLI/skills.md#Athletics) proficiency, you can add half your [Proficiency Bonus](/Mechanics/CLI/variant-rules/proficiency-xphb.md) to the check.
...
You now regain all your expended uses of Bardic Inspiration when you finish a [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md) or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md).
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [Charmed](/Mechanics/CLI/conditions.md#Charmed) or [Frightened](/Mechanics/CLI/conditions.md#Frightened) condition, you can take a [Reaction](/Mechanics/CLI/variant-rules/reaction-xphb.md) to cause the save to be rerolled, and the new roll has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md).
...
When you roll [Initiative](/Mechanics/CLI/variant-rules/initiative-xphb.md), you regain expended uses of Bardic Inspiration until you have two if you have fewer than that.
