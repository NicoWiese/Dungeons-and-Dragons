...
*Use this column for [Cylinders](/Mechanics/CLI/variant-rules/cylinder-area-of-effect-xphb.md), [Emanations](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md) (using the size of the Emanation rather than its radius), and [Spheres](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md).