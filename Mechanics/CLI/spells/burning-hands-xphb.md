...
A thin sheet of flames shoots forth from you. Each creature in a 15-foot [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md) makes a Dexterity saving throw, taking `3d6` Fire damage on a failed save or half as much damage on a successful one.

Flammable objects in the [Cone](/Mechanics/CLI/variant-rules/cone-area-of-effect-xphb.md) that aren't being worn or carried start [burning](/Mechanics/CLI/traps-hazards/burning-xphb.md).
