...
Swarming locusts fill a 20-foot-radius [Sphere](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md) centered on a point you choose within range. The [Sphere](/Mechanics/CLI/variant-rules/sphere-area-of-effect-xphb.md) remains for the duration, and its area is [Lightly Obscured](/Mechanics/CLI/variant-rules/lightly-obscured-xphb.md) and [Difficult Terrain](/Mechanics/CLI/variant-rules/difficult-terrain-xphb.md).
