...
> [!gallery]
> ![Flanaess (Hex Grid)](/Mechanics/CLI/books/dungeon-masters-guide-2024/img/078-map-5-03-flanaess-grid.webp#gallery)
> ![Player Version](/Mechanics/CLI/books/dungeon-masters-guide-2024/img/079-map-5-03-flanaess-player-grid.webp#gallery)
...
> - **Scholarly Expertise.** Characters who have proficiency in the [Arcana](/Mechanics/CLI/skills.md#Arcana), [History](/Mechanics/CLI/skills.md#History), or [Religion](/Mechanics/CLI/skills.md#Religion) skill can be fonts of useful information. When it would be helpful for a group to know something about the setting, ask such characters to make an Intelligence check using the relevant skill, then share plot-relevant details if their roll warrants it.  
